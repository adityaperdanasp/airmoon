// Firebase Web SDK config for the airmoon-d9620 project.
// This is a client identifier, not a secret — Firebase scopes access via
// Firestore/Storage security rules and (optionally) App Check, not by
